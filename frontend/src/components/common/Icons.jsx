...
// All SVG icons used in the dashboard. No external dependency.
// Each icon inherits color from `currentColor` and size from `width`/`height` props.
...
export const ProductsIcon = (p) => (
    <svg {...baseProps} {...p}>
        <path d="M21 8L12 13 3 8M21 8v8l-9 5-9-5V8M21 8l-9-5-9 5" />
    </svg>
);
